...
class AmazonConnectQueuePosition(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
                ...
                "ParameterGroups" : [
                    {
                        ...
                        "Parameters" : [ amazon_connect_id.logical_id, s3_bucket_name.logical_id, deployment_lambda.logical_id  ]
                    },
                ],
                "ParameterLabels" : {
                    amazon_connect_id.logical_id : { "default" : "Amazon Connect Instance ID" },
        ...
        lambda_role_policy = iam.Policy(
            ...
            statements=[
                iam.PolicyStatement(
                    ...
                    actions=["dynamodb:PutItem", "dynamodb:DescribeTable", "dynamodb:DeleteItem",
        ...
        amazon_connect_queue_lambda = _lambda.Function(
            self,
            ...
            code=_lambda.Code.from_bucket(
                ...
                key=deployment_lambda.value_as_string
            ),
